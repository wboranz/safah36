...
[ <a href="index.php">Anasayfa</a> | <a href="iletisim.php">İletişim</a> | <a href="/resimlerim.php">Resimlerim</a> | <a href="http://scriptkuyusu.6te.net">Troypc</a> ]
</center></div>
      </td></tr></table>
    </td>
  </tr>
...
<a href="videolarim.php"><img src="images/li.gif" > Videolarım</a><br><br>
    ...
    <td valign="top" style="height: 100%;">
      ...
      <div class="big"><b>&nbsp;<?=$adiniz; ?> <?=$soyadiniz; ?></b></div>
<table>
<tr>
<td style="width: 478px; height: 150px;" >
<img alt="<?=$adiniz; ?> <?=$soyadiniz; ?>" title="<?=$adiniz; ?> <?=$soyadiniz; ?>" src="images/foto/<?=$resim; ?>" align="right" width="150" height="200" />
<table>
<tr>
<td>
<font color="#cc3366" ><b>Adım:</b></font>
</td>
<td>
<?=$adiniz; ?>
</td>
...
<tr>
<td>
<font color="#cc3366" ><b>Soyadım:</b></font>
</td>
<td>
<?=$soyadiniz; ?>
</td>
...
<tr>
<td>
<font color="#cc3366" ><b>Mesleğim:</b></font>
</td>
<td>
<?=$meslek; ?>
</td>
...
<tr>
<td>
<font color="#cc3366" ><b>E-Posta Adresim:</b></font>
</td>
<td>
<?=$email; ?>
</td>
...
<tr>
<td>
<font color="#cc3366" ><b>Doğum Yerim:</b></font>
</td>
<td>
<?=$dyeri; ?>
</td>
...
<tr>
<td>
<font color="#cc3366" ><b>Doğum Yılım:</b></font>
</td>
<td>
<?=$dyili; ?>
</td>
...
<tr>
<td>
<font color="#cc3366" ><b>Hobilerim:</b></font>
</td>
<td>
<?=$hobiler; ?>
</td>
...
<head>
	...
	<title><?=$adiniz; ?> <?=$soyadiniz; ?> :: Anasayfa</title>

</head>
<table>
<tr>
<td>
<font color="#3366ff" ><center><b>Bana Yorum Yapın!</b></center></font>
</td>
<td>
<font color="#3366ff" ><center><b>Yorumlar</b></center></font>
</td>
</tr>

<tr><td>
<form action="yorum_ekleniyor.php" method="post">
<table>
<tr>
<td>
...
<td>
<input type="text" name="yazan" id="yazan" size="20" maxlength="100"><br>
</td>
</tr>

<tr>
<td>
<font color="#3366ff" ><b>Yorum :</b></font>
</td>
<td>
<textarea name="yorum" rows="3" cols="20"  id="yorum" ></textarea><br>
</td>
</tr>
...
include("baglan.php"); 
{
$toplam = mysql_query("SELECT * FROM yorum");
$say=mysql_num_rows($toplam);  
}
if($say<1){
echo "<table><tr><td><b><font color='red' >Yorum Yok</font></b></td></tr><tr><td><b>Bana şuan hiçbir yorum yapılmamış. İlk yorumu yapan olmak isterseniz yan tarafdaki formu kullanın.</b></td></tr></table><br>";  
}
else{
echo "<b>Bana $say kez yorum yapılmış.</b><br>";  
}
...
<? 
include("baglan.php"); 
$sorgu=mysql_query("select * from yorum order by no asc");
while($satir=mysql_fetch_row($sorgu))
{
$no=$satir[0];
$yazan=$satir[1];
...
echo"<table>
<tr>
<td><b><font color='#3366ff'>$yazan </font></b></td></tr>
<tr><td>$yorum</td></tr>
</table><hr />";
}
